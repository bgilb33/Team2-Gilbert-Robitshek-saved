...
File name: Main.c
Description: This file should be flashed onto the ESP32 and will interface with the accelerometer, thermistor, button, and alphanumeric display. 
    This code will print data values to the serial port. 

Attributes: This code is adapted from the previous tasks including primarily from skills
*/ 
